...
{
private:
	static const int kWidth = 877;
	static const int kHeight = 520;
	static const int kPlayerSpeed = 250;
	...
	static const int KgroundSourceXPosition = 0;
	static const int KgroundSourceYPosition = 100;
	static const int KgroundWidth = 877;
	static const int KgroundHeight = 5;



	static const int kBackgroundScrollSpeed = 0;
